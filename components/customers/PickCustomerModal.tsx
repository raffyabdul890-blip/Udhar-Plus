            ...
            {filtered.map((customer) => (
              <li key={customer.id}>
                <button
                  ...
                  className="flex min-h-tap w-full items-center gap-3 rounded-xl border border-border bg-surface px-3 py-2 text-left transition active:scale-[0.99] active:bg-surface-alt"
                >
